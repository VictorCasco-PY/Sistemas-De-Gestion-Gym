...
export default function initModels(sequelize) {
  ...
  const pagos_proveedores_detalles = _pagos_proveedores_detalles.init(sequelize, DataTypes);
  ...
  facturas_proveedores_detalles.belongsTo(facturas_proveedores, { foreignKey: "id_factura_proveedor"});
  facturas_proveedores.hasMany(facturas_proveedores_detalles, { foreignKey: "id_factura_proveedor"});
  pagos_proveedores.belongsTo(facturas_proveedores, { foreignKey: "id_factura_proveedor"});
  facturas_proveedores.hasMany(pagos_proveedores, { foreignKey: "id_factura_proveedor"});
  arqueos_detalles.belongsTo(formas_de_pagos, { foreignKey: "id_forma_de_pago"});
  ...
  facturas_proveedores_detalles.belongsTo(productos, { foreignKey: "id_producto"});
  productos.hasMany(facturas_proveedores_detalles, { foreignKey: "id_producto"});
  ...
  pagos_proveedores.belongsTo(sesiones_cajas, { foreignKey: "id_sesion_caja"});
  sesiones_cajas.hasMany(pagos_proveedores, { foreignKey: "id_sesion_caja"});
